...
const ChatBubble: React.FC<ChatBubbleProps> = ({ message, isCurrentUser }) => {
  ...
  return (
    <div className={`flex items-start ${isCurrentUser ? 'justify-end space-x-reverse space-x-2' : 'justify-start space-x-2'}`}>
      {/* Conditionally render avatar based on isCurrentUser */} 
