    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard
          ...
          value={teamStats.injuredPlayers.toString()}
        ...
        <StatCard
          ...
          value={teamStats.goalsScored.toString()}
        ...
        <CardContent className="space-y-4 pt-0">
          {[
            ...
            },
            {
              ...
              time: 'منذ 4 ساعات',
              icon: <Heart className="w-5 h-5 text-blue-500 dark:text-blue-400" />
            },
            {
              title: 'جدولة مباراة جديدة',
              description: 'تم إضافة مباراة ضد فريق النصر',
              time: 'منذ يوم',
              icon: <CalendarClock className="w-5 h-5 text-purple-500 dark:text-purple-400" />
            }
          ].map((activity, index) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4 pt-0">
            {[
              { team: 'النصر', date: '2024-05-23', time: '20:00', logo: '/images/teams/team1.png' },
              { team: 'الهلال', date: '2024-05-30', time: '19:30', logo: '/images/teams/team2.png' },
              { team: 'الاتحاد', date: '2024-06-05', time: '21:00', logo: '/images/teams/team3.png' }
            ].map((match, index) => (
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-xl">إحصائيات الفريق</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6 pt-0">
            ...
            <Button variant="outline" className="w-full">تحليل أعمق</Button>
          </CardContent>
        </Card>
      </div>
